...
def validate_file_type(file_path: str, file_types: List[str], message: str = "") -> None:
    """
...
def validate_values_in_given_list(iter: Iterable, allowed_values: List[Any], message: str = "") -> None:
    """
